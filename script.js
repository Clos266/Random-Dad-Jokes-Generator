    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    data = _a.sent();
                    jokeContainer.innerHTML = "<p>".concat(data.joke, "</p>");
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error al traer el chiste:', error_1);
...
// Cargar chiste al cargar la página
traerChiste();
// Cambiar chiste al hacer click
